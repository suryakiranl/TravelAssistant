...
public class WeatherInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		if (weather == null) {
			throw new RuntimeException(
					"Error when retrieving weather information.");
		}
	...
	protected void doPost(HttpServletRequest request,
		...
		response.getWriter()
				.write("POST method is not implemented for this Servlet. Please use GET.");
	...
	private String prepareCurrentCondition(WeatherAPIResponse weather) {
		...
		sb.append("Displaying weather information for " + req.getType()
				+ " : <strong>" + req.getQuery() + "</strong>");
		sb.append("<hr/>");
		sb.append("<strong>Weather Information:</strong>");

		sb.append("<div class='container'>");
		sb.append("<div class='row'><div class='col-md-2'>");
		sb.append("Reading recorded at: </div><div class='col-md-2'>"
				+ cc.getObservation_time() + " (Local Time)");
		sb.append("</div></div><div class='row'><div class='col-md-2'>");
		sb.append("Temperature: </div><div class='col-md-2'>" + cc.getTemp_F()
				+ "F / " + cc.getTemp_C() + "C");
		sb.append("</div></div><div class='row'><div class='col-md-2'>");
		sb.append("Cloud Cover: </div><div class='col-md-2'>"
				+ cc.getCloudcover() + "%");
		sb.append("</div></div><div class='row'><div class='col-md-2'>");
		sb.append("Humidity: </div><div class='col-md-2'>" + cc.getHumidity()
				+ "%");
		sb.append("</div></div><div class='row'><div class='col-md-2'>");
		sb.append("Weather Description: </div><div class='col-md-2'>"
				+ cc.getWeatherDesc()[0].getValue());
		sb.append("</div></div><div class='row'><div class='col-md-2'>");
		sb.append("Wind Speed: </div><div class='col-md-2'>"
				+ cc.getWindspeedMiles() + "mph");
		sb.append("</div></div><div class='row'><div class='col-md-2'>");
		sb.append("Wind direction: </div><div class='col-md-2'>"
				+ cc.getWinddir16Point());
		sb.append("</div></div><div class='row'><div class='col-md-2'>");
		sb.append("Weather Icon: </div><div class='col-md-2'><img src='"
				+ cc.getWeatherIconUrl()[0].getValue()
