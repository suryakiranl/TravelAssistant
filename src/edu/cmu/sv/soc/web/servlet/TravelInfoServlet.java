...
public class TravelInfoServlet extends HttpServlet {
	...
	/**
	 * @param travel - TravelSearchResponse
	 */	
	private String prepareCurrentStatus(TravelSearchResponse travel) {
		...
		sb.append("Distance: </div><div class='col-md-2'>" + routes[0].getDistance() + " miles");
		sb.append("</div></div><div class='row'><div class='col-md-2'>");
		sb.append("Duration: </div><div class='col-md-2'>" + routes[0].getDuration() + " minutes");
		sb.append("</div></div><div class='row'><div class='col-md-2'>");
		sb.append("Stops: </div><div class='col-md-2'>" + stops[0].getName());
		sb.append("</div></div><div class='row'><div class='col-md-2'>");
		sb.append("</div></div><div class='row'><div class='col-md-2'>");
		sb.append("Airline: </div><div class='col-md-2'>" + airline[0].getName());
		sb.append("</div></div><div class='row'><div class='col-md-2'>");
